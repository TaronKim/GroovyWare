...
<script type="text/javascript">
	...
	//회원가입
	function exe() {
		if($("#cid_res").hasClass("chk_sucess") && $("#id_res").hasClass("chk_sucess") && $("#pw_res").hasClass("")){
   ...
   var pw = $("#_userpwdOD");
   var pw2 = $("#_userpwdCD");   
   if(pw2.val().length > 6){  //사용자가 입력한 pw값의 길이가 6자 이상일 때
							...
							<form name="ff" action="" method="post">
								<div onkeypress="">
									<dl>
										...
										<dt>Password</dt>
										<dd class="ico3">
											<span id="_userpwd_wrapper"
												class="riSingle RadInput RadInput_Telerik"
												style="width: 160px;"> 
												<input id="_userpwd"
												name="_userpwd" size="20" class="riTextBox riEnabled"
