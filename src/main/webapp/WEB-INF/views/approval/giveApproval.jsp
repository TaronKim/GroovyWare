											...
											<tbody>
												...
												<c:forEach items="${requestScope.a_list }" var="avo">
													<tr class="rgRow" style="white-space: nowrap;">
														<td class="col_ct"><a href="#view_draft" class="btn_update"
															onclick="viewDraft('${avo.dvo.draft_code}') ">
																${avo.dvo.draft_code } <input type="hidden" name="approval_idx" value="${avo.approval_idx}"></a></td>
														<td class="col_ct">${fn:substring(avo.dvo.draft_year,0,10) }</td>
														<td class="col_lf">${avo.dvo.evo.e_name}<input type="hidden" name="e_code" value="${avo.dvo.evo.e_code}"></td>
